...
train_data = pd.read_csv('../../data/synch_ship_cir_train01.csv')
eval_data = pd.read_csv('../../data/synch_ship_cir_train02.csv')
...
# torch.save(model.state_dict(), 'transformer_rawinput_cir_512.pth')
# print("Training complete. Model saved as 'transformer_rawinput_cir_512.pth'.")
...
tum_groundtruth.to_csv(f'groundtruth_tum_cir_{date_str}.txt', sep=' ', index=False, header=False)
tum_predicted.to_csv(f'predicted_tum_cir_{date_str}.txt', sep=' ', index=False, header=False)
